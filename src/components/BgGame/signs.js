...
export default {
  ...
  moon: () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 127 127">
      <path
        ...
        d="m20,28 a 52,52 0 1,1 0,78 a 41,41 0 1,0 0-78 l 2-2"
      />
    </svg>
  ),
  silver: () => (
  ...
  vinegar: () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
      ...
      <circle cx="16" cy="32" r="2" fill="#000" />
      ...
      {/* Left, right */}
      <path  strokeWidth="0.5" d="m5.25,25 v-8 Q 6,23 15,24 z" />
      <path  strokeWidth="0.5" d="m5.25,25 v8 Q 6,27 15,26 z" />
      <path  strokeWidth="0.5" d="m44.75,25 v-8 Q 44,23 35,24 z" />
      <path  strokeWidth="0.5" d="m44.75,25 v8 Q 44,27 35,26 z" />
      {/* Top, bottom */}
      <path  strokeWidth="0.5" d="m25,5.25 h8 Q 23,6 24,35 z" />
      <path  strokeWidth="0.5" d="m25,5.25 h-8 Q 27,6 26,35 z" />
      <path  strokeWidth="0.5" d="m25,44.75 h8 Q 23,44 24,15 z" />
      <path  strokeWidth="0.5" d="m25,44.75 h-8 Q 27,44 26,15 z" />
    </svg>
  ),
  sulfuricAcid1: () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
